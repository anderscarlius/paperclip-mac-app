        ...
        <span className="flex items-center gap-2 sm:order-1 sm:shrink-0">
          ...
          {desktopMetaLeading ?? (
            <>
              ...
              <span className="hidden shrink-0 rounded border border-border px-1.5 py-0.5 text-[10px] font-medium text-muted-foreground sm:inline-flex">
                {issueModeLabels[issue.mode ?? "normal"]}
              </span>
            </>
          )}
          {mobileMeta ? (
