...
import type { IssueMode } from "@paperclipai/shared";
...
const issueModes: Array<{ value: IssueMode; label: string }> = [
...
export function NewIssueDialog() {
  ...
  const [mode, setMode] = useState<IssueMode>("normal");
  ...
  useEffect(() => {
    ...
    if (newIssueDefaults.parentId) {
      ...
      setMode(newIssueDefaults.mode ?? "normal");
      ...
      setMode(newIssueDefaults.mode ?? draft.mode ?? "normal");
      setAssigneeValue(
